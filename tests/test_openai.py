...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [{"role": "user", "content": "hello"}],
            {"temperature": 0.1, "thinking": {"type": "enabled", "effort": "high"}},
            "Act as a child.",
            {
                "messages": [
                    {"role": "system", "content": "Act as a child."},
        ...
        (
            ...
            [{"role": "user", "content": "hello"}],
            {"thinking": {"type": "enabled", "max_tokens": 2048, "exclude": True}},
            "Act as a child.",
            {
                "messages": [
                    {"role": "system", "content": "Act as a child."},
                ...
                "response_format": {"type": "text"},
                "stream": False,
                "reasoning": {"enabled": True, "exclude": True, "max_tokens": 2048},
            },
        ),
    ],
)
